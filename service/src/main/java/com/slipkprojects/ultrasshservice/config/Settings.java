...
public class Settings implements SettingsConstants
{
	...
	*/
	...
	// Filter app on 
	public static void filterappAtivado(Context context) {
        Editor edit = PreferenceManager.getDefaultSharedPreferences(context).edit();
        edit.putBoolean(SettingsConstants.FILTER_APPS, true);
        edit.commit();
		}
	
	// Filter app off
    public static void filterappDesativado(Context context) {
        Editor edit = PreferenceManager.getDefaultSharedPreferences(context).edit();
        edit.putBoolean(SettingsConstants.FILTER_APPS, false);
        edit.commit();
		}
	...
	*/
	...
	public static void setDefaultConfig(Context context){
		...
		editor.putBoolean(WAKELOCK_KEY, false); // Wakelock

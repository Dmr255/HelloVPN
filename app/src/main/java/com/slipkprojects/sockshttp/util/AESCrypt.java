...
public final class AESCrypt {
    ...
    private static final String jaTest = "4paZ4paa4pab4pac4pad4pae4paf4paD4paE4paF4paG4paH4paI4paJ4paK4paQ";
    ...
    private static String jagen(byte[] bArr) {
        char[] charArray = JaTest(jaTest).toCharArray();
        StringBuilder sb = new StringBuilder();
        for (byte b : bArr) {
            sb.append(charArray[(b & 240) >> 4]);
            sb.append(charArray[b & 15]);
